...
имеет_сына(Родитель,Сын):-родитель_ребёнок(Родитель, Сын), мужчина(Сын).
имеет_внука(Кто,Внук):-имеет_сына(Кто,Сын),имеет_сына(Сын,Внук).

многодетен(Х):- родитель_ребёнок(Х,Р1),родитель_ребёнок(Х,Р2), Р1\=Р2,
                 родитель_ребёнок(Х,Р3), Р3\=Р1, Р3\=Р2.